...
1. `starlight-plugin-add-integration-test` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   npm install starlight-plugin-add-integration-test
   ```
   ...
   ```sh
   pnpm add starlight-plugin-add-integration-test
   ```
   ...
   ```sh
   yarn add starlight-plugin-add-integration-test
   ```
